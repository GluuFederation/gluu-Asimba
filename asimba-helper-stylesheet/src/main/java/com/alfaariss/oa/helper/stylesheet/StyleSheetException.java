...
/**
 * Exception for StyleSheet helper errors.
 *
 * @author MHO
 * @author Alfa & Ariss
 *
...
public class StyleSheetException extends OAException
{
    ...
    /**
     * Create a new <code>StyleSheetException</code>.
     * @param iCode The error code.
     */
    public StyleSheetException (int iCode)
    {
        super(iCode);
    }
     ...
     */
    public StyleSheetException (int iCode, Throwable tCause)
    {
        super(iCode, tCause);
    }
}