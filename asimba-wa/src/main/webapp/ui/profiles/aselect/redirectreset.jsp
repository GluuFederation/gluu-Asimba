...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta http-equiv="REFRESH" content="0;URL='<c:out value='${requestScope.redirect}'/>'" />
		...
		<div id="container">
			...
			<div id="content">	
				<div id="contentHeader">	
					<h2>
						<fmt:message bundle="${messages}" key="redirectreset_page_title">
							<fmt:param>
				...
				<div id="contentMain">							
					<fieldset>
	                	<a href="${requestScope.redirect}"><fmt:message bundle='${messages}' key='redirectreset_continue_button'/></a>
                    </fieldset>	
				</div>
			</div>
			<div id="footer">
