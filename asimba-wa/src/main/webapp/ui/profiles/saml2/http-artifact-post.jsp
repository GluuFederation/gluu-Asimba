	...
	<body onload="document.forms[0].submit()">
		<div id="container">
			...
			<div id="content">
				...
				<div id="contentMain">					
					<form id="saml2ArtifactForm" class="oaForm" action="${requestScope.action}" method="post">
						<fieldset>
							<c:if test="${requestScope.RelayState != null}">
								<input type="hidden" name="RelayState" value="<c:out value="${requestScope.RelayState}"/>"/>
							</c:if>
	                		<input type="hidden" name="SAMLArt" value="${requestScope.SAMLArt}"/>
	                		<noscript>
