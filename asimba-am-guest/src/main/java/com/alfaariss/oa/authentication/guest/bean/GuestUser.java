...
public class GuestUser extends AbstractUser
{
     ...
     * @param sUserId The unique user ID.
     * @param sOrganization The user organization
     * @param sMethodID Method id
     */
    public GuestUser(String sOrganization, String sUserId, String sMethodID)
    {
    ...
    /**
     * @see com.alfaariss.oa.api.user.IUser#isAuthenticationRegistered(java.lang.String)
     */
