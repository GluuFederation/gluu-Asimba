...
/**
 * An OA logitem for logging user event messages.
 * @author MHO
 * @author EVB
 * @author JRE
 * @author Alfa & Ariss
 *
 */
public class UserEventLogItem extends AbstractEventLogItem
{
    private final static Integer LOG_EVENT_TYPE = new Integer(1);
    private UserEvent _event = null;
  
    /**
     * Create a new <code>UserEventLogItem</code>.    
     * @param sessionId The session ID.
     * @param tgtId The TGT id.
     * @param type The identifier of the phase in the authentication proces.
     * @param userEvent The event.
     ...
     * @since 1.2
     */    
    public UserEventLogItem (String sessionId, String tgtId, SessionState type, 
        UserEvent userEvent, String userId, String organizationId, 
     ...
     */    
    public UserEventLogItem (String sessionId, String tgtId, SessionState type, 
        UserEvent userEvent, String userId, String ipAddress, String requestor, 
     ...
     * @param userEvent The event to be logged.
     * @param authority The Authority the caller represents.
     * @param message Additional information.
     */
    public UserEventLogItem (ISession oSession, 
        String ipAddress, UserEvent userEvent, IAuthority authority, String message)
    {
