...
/**
 * Utility class to validate TGT related objects.
 * @author EVB
 * @author Alfa & Ariss
 *
 */
...
{
    /**
     *  The validation pattern for TGT ID's.
     */
    public static final Pattern ID_PATTERN = Pattern.compile("[A-Za-z0-9-_]{170,172}");
    
    /**
     * Validate a Modified Base64 encoded TGT id.
     * @param sId The id to be validated.
     * @return <code>true</code> if the given id is not <code>null</code> 
     *  and it matches  {@link TGTValidator#ID_PATTERN}.
     */
    public static boolean validateDefaultTGTId(String sId)
    {
        if(sId == null)
            return false;
